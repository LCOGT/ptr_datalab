...
def create_jpgs(fits_paths: str, large_jpg_path, thumbnail_jpg_path, color=False, zmin=None, zmax=None) -> list:
  ...
  fits_to_img(fits_paths, large_jpg_path, JPEG_EXTENSION, width=max_width, height=max_height, color=color, zmin=zmin, zmax=zmax)
  fits_to_img(fits_paths, thumbnail_jpg_path, JPEG_EXTENSION, color=color, zmin=zmin, zmax=zmax)
