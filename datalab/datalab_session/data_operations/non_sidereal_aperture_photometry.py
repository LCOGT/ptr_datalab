...
class NonSiderealAperturePhotometry(BaseDataOperation):
        ...
        return {
            ...
            'inputs': {
                'input_files': {
                    ...
                    'minimum': NonSiderealAperturePhotometry.MINIMUM_NUMBER_OF_INPUTS,
                    'maximum': NonSiderealAperturePhotometry.MAXIMUM_NUMBER_OF_INPUTS,
                },
                'aperture_radius': {
    ...
    def operate(self, submitter: User):
        ...
        log.info(f"Non-Sidereal Aperture Photometry operation on {', '.join([image['basename'] for image in input_files])}")
        ...
        try:
            ...
            self.set_operation_progress(NonSiderealAperturePhotometry.PROGRESS_STEPS['INPUT_PROCESSING_PERCENTAGE_COMPLETION'])
            ...
            log.warning(f"Non-Sidereal Aperture Photometry failed: {exc}")
        ...
        self.set_operation_progress(NonSiderealAperturePhotometry.PROGRESS_STEPS['APERTURE_PHOTOMETRY_PERCENTAGE_COMPLETION'])
        ...
        self.set_operation_progress(NonSiderealAperturePhotometry.PROGRESS_STEPS['OUTPUT_PERCENTAGE_COMPLETION'])
        self.set_status('COMPLETED')
        log.info(
            "Non-Sidereal Aperture Photometry output: "
